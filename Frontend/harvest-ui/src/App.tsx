...
export default function App() {
    ...
    return (
        <div style={styles.page}>
            ...
            {/* Either Splash + Details, or Results screen */}
            {showResults ? (
...
function Hero(props: {
    ...
    const { scytheLogo, location, setLocation, soil, setSoil, ground, setGround, price, setPrice, onExplore } = props;
    return (
        <header style={styles.hero}>
            <div style={styles.cardWrap}>
                ...
                <div style={styles.form}>
                    ...
                    <select id="soil" style={styles.input} value={soil} onChange={(e) => setSoil(e.target.value)}>
                    ...
                    <select id="ground" style={styles.input} value={ground} onChange={(e) => setGround(e.target.value)}>
                    ...
                    <select id="price" style={styles.input} value={price} onChange={(e) => setPrice(e.target.value)}>
                    ...
                    <button style={styles.cta} onClick={onExplore}>Explore</button>
                </div>
            </div>
...
const styles: Record<string, React.CSSProperties> = {
    ...
    hero: {
        ...
        display: "grid",
        placeItems: "center",
        background: "radial-gradient(1200px 600px at 70% -10%, rgba(255,255,255,.60) 0%, rgba(246,248,251,.45) 40%, rgba(233,238,245,.25) 60%, rgba(233,238,245,0) 100%), linear-gradient(135deg, #f6f8fb 0%, #eef2f7 50%, #e9eef5 100%)",
        position: "relative",
        padding: "40px 6vw",
    },
    cardWrap: {
    ...
    cardShine: {
        ...
        width: "140%",
        height: 200,
        background: "radial-gradient(ellipse at top left, rgba(255,255,255,.85) 0%, rgba(255,255,255,.35) 45%, rgba(255,255,255,0) 70%)",
        filter: "blur(6px)",
        pointerEvents: "none",
